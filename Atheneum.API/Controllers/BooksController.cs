...
namespace Atheneum.API.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public BooksController(AtheneumDbContext context, IMapper mapper, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
            this.mapper = mapper;
        ...
        public async Task<ActionResult<IEnumerable<BookReadDto>>> GetBooks()
        {
            var bookDtos = await _context.Books
                .Include(q => q.Author)
                .ProjectTo<BookReadDto>(mapper.ConfigurationProvider)
                .ToListAsync();
