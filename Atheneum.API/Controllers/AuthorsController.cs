...
namespace Atheneum.API.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        public AuthorsController(AtheneumDbContext context, IMapper mapper, ILogger<AuthorsController> logger)
        {
            _context = context;
            this.mapper = mapper;
            this.logger = logger;
        ...
        public async Task<ActionResult<IEnumerable<AuthorReadDto>>> GetAuthors()
        {
            try
            {
                ...
                var authorDtos = mapper.Map<IEnumerable<AuthorReadDto>>(authors);
...
;
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                {
                    logger.LogWarning(ex, $"Error performing PUT in {nameof(PutAuthor)}");
                    return StatusCode(500, Messages.Error500Message);
                }
            }
        ...
        public async Task<IActionResult> DeleteAuthor(int id)
        {
            ...
            {
                logger.LogWarning(ex, $"Error performing DELETE in {nameof(DeleteAuthor)}");
                return StatusCode(500, Messages.Error500Message);
            }
        }
