...
builder.Services.AddIdentityCore<APIUser>()
    ...
    .AddEntityFrameworkStores<AtheneumDbContext>();
...
builder.Host.UseSerilog((context, loggingConfiguration) => loggingConfiguration.WriteTo.Console().ReadFrom.Configuration(context.Configuration));
